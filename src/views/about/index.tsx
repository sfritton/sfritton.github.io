  ...
  return (
    <div className={styles.layout}>
      ...
      <div>
        ...
        with a talented team of engineers at Target, but I&#39;m always busy with a side project or
        two. My passions include building responsive, accessible websites, designing &amp;
        developing games, and exploring new ideas through simulations.
      </div>
    </div>
  );
};
